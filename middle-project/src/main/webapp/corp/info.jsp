 ...
 <section class="w1200 p40">
      <div class="info_wrap">
        <div class="info_left">
          ...
          <ul>
            <li class="info_title"><a class="nav-link log-nav" href="${pageContext.request.contextPath }/mem/corpinfo.do">회사 정보 등록</a></li>
            <li class="info_title"><a class="nav-link log-nav" href="${pageContext.request.contextPath }/mem/corpedit.do">회사 정보 수정</a></li>
          </ul>
